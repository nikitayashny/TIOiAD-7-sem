...
axes[0].legend(['Класс 0', 'Класс 1'], loc=3)
plt.show()
...
plt.legend()
plt.title("Правильность KNN на обучающем и тестовом наборах")
plt.show()

mglearn.plots.plot_knn_regression(n_neighbors=1)
plt.title("KNN Regression (n_neighbors=1)")
plt.show()

mglearn.plots.plot_knn_regression(n_neighbors=3)
plt.title("KNN Regression (n_neighbors=3)")
plt.show()
